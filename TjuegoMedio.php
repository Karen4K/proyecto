...
<body>
    <div class="contenedor">
        ...
        <div class="ContenedorJuego4k">
            <div id="ContenedorPreguntas4k">
                ...
                <button id="regresar" onclick="location.href='Contactanos.html'">Regresar</button>
            </div>
        </div>
    </div>
    <script>
    ...
    // Comprueba si el número de respuestas correctas es igual a 3
    if (correctCount === 3) {
    ...
    //*
    //Funcion que pasa la calificaion 
       // function calificacion4k(){
            // Obtienen¿mos el número de respuestas correctas desde el elemento con id 'correct-count' usando contante 'const'
   // const correctCount = parseInt(document.getElementById('correct-count').textContent);
          //  if(correctCount ===1){
               // $calificacion = "33%";
